...
import PlanetCard from '../cardsStyles/Planet'
        ...
        <>
            <div className='dark:bg-gray-800'>
                <div className="container mx-auto">
                    <h1 className='text-center pt-10 dark:text-white text-7xl'>Planets</h1>
                    <p className='text-center py-8 dark:text-white'>A Planets resource is an individual planets within the Star Wars universe.</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        {planets.map((planet, index) => (
                            <PlanetCard planet={planet} index={index} />


                            // moved to PeopleCard.jsx
